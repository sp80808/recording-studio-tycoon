...
export const lyricFocusThemes: LyricFocusTheme[] = [
  ...
  {
    id: 'hipHopStruggle',
    name: 'Hip-Hop Struggle Story',
    genre: 'hip-hop' as MusicGenre,
    mood: 'Intense, Motivational',
    description: 'A track about overcoming adversity and making it through tough times.',
    coreConcepts: ['Struggle', 'Success', 'Streets', 'Hustle'],
    keywords: [
      createKeyword('streets'), createKeyword('city'), createKeyword('money'),
      createKeyword('freedom'), createKeyword('broken'), createKeyword('fire'),
      createKeyword('hope'), createKeyword('pain'), createKeyword('dark'),
      createKeyword('journey'),
      // Distractors or less relevant
      createKeyword('summer'), createKeyword('party'), createKeyword('computer'), createKeyword('job'),
    ].sort(() => 0.5 - Math.random()),
  },
  {
    id: 'electronicNightlife',
    name: 'Electronic Nightlife',
    genre: 'electronic' as MusicGenre,
    mood: 'Energetic, Club',
    description: 'An upbeat track perfect for the dancefloor and nightclub scene.',
    coreConcepts: ['Dancing', 'Night', 'Energy', 'Club'],
    keywords: [
      createKeyword('dance'), createKeyword('party'), createKeyword('night'),
      createKeyword('city'), createKeyword('fire'), createKeyword('light'),
      createKeyword('freedom'), createKeyword('stars'), createKeyword('echo'),
      createKeyword('dream'),
      // Distractors or less relevant
      createKeyword('pain'), createKeyword('broken'), createKeyword('job'), createKeyword('computer'),
    ].sort(() => 0.5 - Math.random()),
  },
];
