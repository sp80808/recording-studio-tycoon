...
import { GameState, FocusAllocation, Project, ProjectReport } from '@/types/game';
...
export interface UseStageWorkProps { // Added export
  ...
  completeProject: (project: Project, addStaffXP: (staffId: string, amount: number) => void) => ProjectReport | undefined;
...
export const useStageWork = ({
  ...
  const performDailyWork = useCallback((): { review: ProjectReport | null; isComplete: boolean; finalProjectData: Project | null } | undefined => {
    ...
    if (allStagesComplete) {
      ...
      return { review, isComplete: true, finalProjectData: finalProject };
    }
    ...
    return { review: null, isComplete: false, finalProjectData: null };
