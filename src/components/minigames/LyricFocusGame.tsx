...
import { getLyricFocusThemeForProject, lyricFocusThemes } from '@/data/lyricFocusData'; // Assuming this data file will be created
...
export const LyricFocusGame: React.FC<LyricFocusGameProps> = ({
  ...
  const initializeGame = useCallback(() => {
    ...
    gameAudio.playClick(); // Changed from playStartMinigame
  ...
  const handleKeywordSelect = (keyword: LyricFocusKeyword) => {
    ...
    setGameState(prev => {
      ...
      if (isSelected) {
        ...
        gameAudio.playClick(); // Changed from playUIClick
      } else {
  ...
  const endGame = useCallback(() => {
    ...
    gameAudio.playSuccess(); // Changed from playCompleteMinigame
