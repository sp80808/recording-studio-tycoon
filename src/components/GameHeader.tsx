            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center gap-1 cursor-default px-2 py-1 rounded hover:bg-gray-700/30">
                  ...
                  <AnimatedNumber value={gameState.money} formatValue={(val) => `$${Math.round(val).toLocaleString()}`} className="text-green-400 font-bold text-sm" />
                </div>
              </TooltipTrigger>
              <TooltipContent>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center gap-1 cursor-default px-2 py-1 rounded hover:bg-gray-700/30">
                  ...
                  <AnimatedNumber value={gameState.reputation} formatValue={(val) => `${Math.round(val).toLocaleString()} Rep`} className="text-blue-400 font-bold text-sm" />
                </div>
              </TooltipTrigger>
              <TooltipContent>
